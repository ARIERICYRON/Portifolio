...
export const themes = [
  { name: "blue", label: "Blue", value: blueTheme },
  { name: "brown", label: "Brown", value: brownTheme },
  { name: "purple", label: "Purple", value: purpleTheme },
  { name: "green", label: "Green", value: greenTheme },
  { name: "red", label: "Red", value: redTheme },
  { name: "black", label: "Black", value: blackTheme },
  { name: "pink", label: "Pink", value: pinkTheme },
  { name: "violet", label: "Violet", value: violetTheme },
  { name: "teal", label: "Teal", value: tealTheme },
  { name: "orange", label: "Orange", value: orangeTheme },
  { name: "yellow", label: "Yellow", value: yellowTheme },
  { name: "materialDark", label: "Material Dark", value: materialDarkTheme },
  { name: "materialLight", label: "Material Light", value: materialLightTheme },
  { name: "materialTeal", label: "Material Teal", value: materialTealTheme },
];
